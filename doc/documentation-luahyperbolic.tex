...
local B = 2*A
local C = (1-complex.I)/2
local D = B*complex.I
local E = complex.exp_i(-5*math.pi/6)/2
hyper.tikzBegin()
...
\subsection{Printing custom strings into the TikZ picture}
...
\subsection{luahyperbolic-tikz (requires and copies luahyperbolic-core)}

Functions beginning with underscore are available in the module but should not be needed for normal use.
