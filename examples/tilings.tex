...
\section*{Triangle tilings of type $(p,\infty,\infty)$ for $p\leq 6$}
...
\section*{Triangle tilings of type $(p,q,\infty)$ for $2\leq p\leq q \leq 5$}
...
\newpage
\section*{Triangle tilings of type $(p,q,r)$ for $2\leq p\leq q\leq r \leq 6$}
